...
//}
//
//shared_ptr<Object> ObjectResolver::visitIfClause(IfClauseCtx &ctx) {
...
//}
//
//void ObjectResolver::visitIfExpr(IfExprCtx &ctx) {
...
//}
//
//void ObjectResolver::visitListExpr(ListExprCtx &ctx) {
//  // Use a type resolver to get the type.
//  TypeResolver typeResolver(interpreter, getCurrentScope());
//  ctx.accept(typeResolver);
//
//  shared_ptr<ArrayType> arrayType =
//      static_pointer_cast<ArrayType>(typeResolver.getLastType());
